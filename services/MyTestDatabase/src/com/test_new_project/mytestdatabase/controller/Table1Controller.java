...
import com.test_new_project.mytestdatabase.service.Table1Service;
...
public class Table1Controller {
    ...
    @RequestMapping(value="/{id:.+}/table2sForColumn2", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the table2sForColumn2 instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Table2> findAssociatedTable2sForColumn2(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated table2sForColumn2");
        return table1Service.findAssociatedTable2sForColumn2(id, pageable);
    }
